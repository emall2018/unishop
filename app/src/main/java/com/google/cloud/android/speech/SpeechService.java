...
import static com.google.cloud.android.speech.SupportedLanguages.tostt;
...
public class SpeechService extends Service {
    ...
    private String getDefaultLanguageCode() {
     ...
     String   mlanguage= mSharedPreferences.getString(Constants.Language,"");
        String stt=tostt(mlanguage);
